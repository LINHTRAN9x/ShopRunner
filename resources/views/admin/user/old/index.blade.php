                                           ...
                                           <span id="delRes_{{$user->id}}">
                                             @if($user->deleted_at)
                                                   <button type="button" class="btn btn-success"
                                                           onclick="restoreProductComment(this, {{ $user->id }})" title="Restore"
                                                           data-url="{{ route('users.restore', $user->id) }}"
                                                           id="restoreBtn_{{ $user->id }}">
                                                        <i class="fas fa-undo"></i>
                                                </button>
                                               @else
                                                   <a title="Delete" href="#" class="btn btn-danger delete-user"
                                                      onclick="deleteProductComment(this, {{ $user->id }})"
...
{{--    </script>--}}
{{--    <script>--}}
{{--        function deleteProductComment(button, userId) {--}}
...
{{--                    if (response.success) {--}}
{{--                        alertify.success(response.message);--}}
{{--                        $('#delRes_' + userId).html(response.html);--}}
{{--                    } else {--}}
{{--                        alertify.error(response.message);--}}
{{--                    }--}}
{{--                },--}}
...
{{--        function restoreProductComment(button, userId) {--}}
{{--            const url = $(button).data('url');--}}
